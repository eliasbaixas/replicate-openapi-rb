...
module Replicate
  class PredictionsCreateRequest
    ...
    attr_accessor :webhook_events_filter
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Replicate::PredictionsCreateRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Replicate::PredictionsCreateRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'webhook_events_filter')
        if (value = attributes[:'webhook_events_filter']).is_a?(Array)
          self.webhook_events_filter = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          version == o.version &&
          webhook == o.webhook &&
          webhook_events_filter == o.webhook_events_filter
    end
    ...
    def hash
      [input, stream, version, webhook, webhook_events_filter].hash
    end
